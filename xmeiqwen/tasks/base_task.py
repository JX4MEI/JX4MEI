...
from xmeiqwen.common.dist_utils import get_rank, get_world_size, is_main_process, is_dist_avail_and_initialized
from xmeiqwen.common.logger import MetricLogger, SmoothedValue
from xmeiqwen.common.registry import registry
from xmeiqwen.datasets.data_utils import prepare_sample
...
class BaseTask:
    ...
    def setup_task(cls, **kwargs):
        return cls() # 'xmeiqwen.tasks.image_text_pretrain.ImageTextPretrainTask'
    ...
    def build_datasets(self, cfg):
        ...
        for name in datasets_cfg:
            ...
            builder = registry.get_builder_class(name)(dataset_cfg, model_cfg) 
